        ...
        <div class="card">
            ...
            <div class="card-header border-bottom">
                <h5 class="card-title mb-0">
                    <span class="fw-normal">Add Warehouse</span>
                </h5>
            </div>
                            ...
                            <div class="col-sm-12 col-md-6">
                                ...
                                <div class="form-floating form-floating-outline mb-5 mt-2">
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                        ...
                                        aria-label="Warehouse Name" value="{{ old('name') }}" />
                            ...
                            <div class="col-sm-12 col-md-6"><!-- Address -->
                                <div class="form-floating form-floating-outline mb-5 mt-2">
                                    <input type="text" class="form-control @error('address') is-invalid @enderror"
                                        ...
                                        aria-label="Warehouse Address" value="{{ old('address') }}" />
                            ...
                            <div class="col-sm-12 col-md-6"><!-- Is Active -->
                                <div class="form-floating form-floating-outline mb-5">
                                    <select id="warehouse-is-active"
                                        ...
                                        <option value="0" {{ old('is_active', 0) == 0 ? 'selected' : '' }}>Inactive
                                        </option>
                                    </select>
