        ...
        <div class="card">
            ...
            <div class="card-header border-bottom">
                <h5 class="card-title mb-0">
                    <span class="fw-normal">Add Supplier</span>
                </h5>
            </div>
            ...
            <div class="card-body">
                <div class="offcanvas-body mx-0 flex-grow-0 h-100 mt-2">
                    ...
                    <form class="supplier pt-0" id="supplierForm" method="POST" action="{{ route('suppliers.store') }}">
                        @csrf
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-floating form-floating-outline mb-5 mt-2">
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                        ...
                                        aria-label="Supplier Name" value="{{ old('name') }}" />
