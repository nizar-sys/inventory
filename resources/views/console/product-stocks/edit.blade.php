@extends('layouts.app')
@section('title', 'Edit Product Stocks')
        ...
        <div class="card">
            <div class="card-header border-bottom">
                <h5 class="card-title mb-0">
                    <span class="fw-normal">Edit Product Stock</span>
                </h5>
            </div>
                                ...
                                <div class="form-floating form-floating-outline">
                                    <select class="form-select @error('type') is-invalid @enderror" id="type"
                                        ...
                                        @foreach ($enumTypes as $type)
                                            <option value="{{ $type }}"
                                                {{ old('type', $stock->type) == $type ? 'selected' : '' }}>
                                                {{ $type }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-floating form-floating-outline mb-5 mt-2">
                                    <input type="number" class="form-control @error('quantity') is-invalid @enderror"
                                        ...
                                        aria-label="Product quantity" value="{{ old('quantity', $stock->quantity) }}" />
...
@push('scripts')
    @vite('resources/js/console/product-stocks/edit_script.js')
@endpush
